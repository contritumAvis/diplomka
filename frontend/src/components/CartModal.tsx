...
//   return (
//     <div className="fixed inset-0 flex justify-center z-50 overflow-auto py-10">
//       <div className="bg-white w-full max-w-[1320px] shadow-lg rounded-md">
//         <Container className="flex flex-col gap-0">
//           {/* Заголовок */}
//           <div className="w-full h-[64px] flex items-center px-6 md:px-24 pt-5 pb-5">
//             <h2 className="text-gray-900 font-medium text-[18px] leading-6">Cart</h2>
//           </div>
...
//                   {/* Крестик */}
//                   <button onClick={() => handleRemove(item.productId)} className="hover:scale-110 transition-transform">
//                     <svg
//                       width="24"
//                       height="24"
//                       viewBox="0 0 24 24"
